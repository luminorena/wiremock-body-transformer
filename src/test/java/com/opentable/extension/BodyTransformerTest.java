...
public class BodyTransformerTest {
    ...
    public WireMockRule wireMockRule = new
        WireMockRule(wireMockConfig().port(8080).extensions(new BodyTransformer()));
    ...
    public void willReturnFieldWithNameValueWhenOnlyRootElementForXml() {
        wireMockRule.stubFor(post(urlMatching("/test/rootXml"))
            .willReturn(aResponse()
                ...
                .withTransformerParameter("urlRegex", "/__files/rootXml")));
    ...
    public void testKeyValueAsQueryString() {
        wireMockRule.stubFor(get(urlEqualTo("/test?foo=bar"))
            .willReturn(aResponse()
                ...
                .withBody("{\"foo\": \"$(foo)\"}")
                .withTransformers("body-transformer")
                .withTransformerParameter("urlRegex", "/test")));
    ...
    public void withBodyFileName() {
        wireMockRule.stubFor(post(urlEqualTo("/get/this"))
            .willReturn(aResponse()
                ...
                .withTransformers("body-transformer")
                .withTransformerParameter("urlRegex", "/get/this")));
        given()
            .contentType("application/json")
            .body("{\"var\":1111}")
            .when()
